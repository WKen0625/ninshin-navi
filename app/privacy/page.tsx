...
export const metadata: Metadata = { title: "記録と同意｜Tsugiraku Navi" };
    ...
    <div className="space-y-6">
      ...
      <section className="space-y-2 text-base">
        ...
        <ul className="list-disc space-y-1 pl-6">
          ...
          <li>保存する内容: 施設・予定月（または出産月）・電話した週と結果・施設から言われた締切の週・分娩予約金のおおよその額、または窓口で払った金額の幅など、画面で選んだ項目だけ。分娩方法は、別に同意した場合だけ保存します。</li>
